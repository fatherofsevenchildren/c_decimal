...
START_TEST(s21_greater_or_equal_0) {
  ...
  int check = s21_is_greater_or_equal(value_1, value_2);
...
START_TEST(s21_greater_or_equal_17) {
  ...
  value_2.bits[1] = 0b00000000000000000000000001110100;
  value_2.bits[2] = 0b00000000000000000000000000000000;
  value_2.bits[3] = 0b10000000000010010000000000000000;
  int check = s21_is_greater_or_equal(value_1, value_2);
  int check_origin = s21_TRUE;
  // origin = 1;
  ck_assert_int_eq(check, check_origin);
...
Suite *suite_greater_or_equal(void) {
  Suite *suite =
      suite_create("\033[1;30;47m S21_IS_GREATER_OR_EQUAL \033[0;0;0m");
  TCase *test_case =
      tcase_create("\033[1;30;47m S21_is_greater_or_equal \033[0;0;0m");
  suite_add_tcase(suite, test_case);

  tcase_add_test(test_case, s21_greater_or_equal_0);
  tcase_add_test(test_case, s21_greater_or_equal_1);
  tcase_add_test(test_case, s21_greater_or_equal_2);
  tcase_add_test(test_case, s21_greater_or_equal_3);
  tcase_add_test(test_case, s21_greater_or_equal_4);
  tcase_add_test(test_case, s21_greater_or_equal_5);
  tcase_add_test(test_case, s21_greater_or_equal_6);
  tcase_add_test(test_case, s21_greater_or_equal_7);
  tcase_add_test(test_case, s21_greater_or_equal_8);
  tcase_add_test(test_case, s21_greater_or_equal_9);
  tcase_add_test(test_case, s21_greater_or_equal_10);
  tcase_add_test(test_case, s21_greater_or_equal_11);
  tcase_add_test(test_case, s21_greater_or_equal_12);
  tcase_add_test(test_case, s21_greater_or_equal_13);
  tcase_add_test(test_case, s21_greater_or_equal_14);
  tcase_add_test(test_case, s21_greater_or_equal_15);
  tcase_add_test(test_case, s21_greater_or_equal_16);
  tcase_add_test(test_case, s21_greater_or_equal_17);
  tcase_add_test(test_case, s21_greater_or_equal_18);
  tcase_add_test(test_case, s21_equal_21);
