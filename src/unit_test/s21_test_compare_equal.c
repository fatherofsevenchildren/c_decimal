...
START_TEST(s21_equal_19_max_mantiss_and_scale) {
  s21_decimal value_1 = {{0}}, value_2 = {{0}};
  // value_1 = max; scale = 0;
...
START_TEST(s21_equal_20_max_mantiss_and_scale) {
  s21_decimal value_1 = {{0}}, value_2 = {{0}};
...
START_TEST(s21_equal_21) {
  ...
  int check = s21_is_equal(src1, src2);
  int check_origin = s21_TRUE;
  // origin = 1;
  ck_assert_int_eq(check, check_origin);
}
...
Suite *suite_equal(void) {
  Suite *suite = suite_create("\033[1;30;47m S21_IS_EQUAL \033[0;0;0m");
  TCase *test_case = tcase_create("\033[1;30;47m s21_is_equal \033[0;0;0m");
  suite_add_tcase(suite, test_case);

  tcase_add_test(test_case, s21_equal_0);
  ...
  tcase_add_test(test_case, s21_equal_8);
  tcase_add_test(test_case, s21_equal_9);
  tcase_add_test(test_case, s21_equal_10);
  tcase_add_test(test_case, s21_equal_11);
  tcase_add_test(test_case, s21_equal_12);
  tcase_add_test(test_case, s21_equal_13);
  tcase_add_test(test_case, s21_equal_14);
  tcase_add_test(test_case, s21_equal_15);
  tcase_add_test(test_case, s21_equal_16);
  tcase_add_test(test_case, s21_equal_17);
  tcase_add_test(test_case, s21_equal_18);
  tcase_add_test(test_case, s21_equal_19_max_mantiss_and_scale);
  tcase_add_test(test_case, s21_equal_20_max_mantiss_and_scale);
