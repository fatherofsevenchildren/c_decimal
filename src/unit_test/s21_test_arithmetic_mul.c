...
START_TEST(s21_mul_1) {
  ...
  ck_assert_int_eq(res, origin_res);
}
END_TEST
...
START_TEST(s21_mul_16) {
  ...
  int res = 0, origin_res;
  //   src1 = 4294967306000;
  // result = 4337916979060.00;
  src1.bits[0] = 0b00000000000000000010011100010000;
  src1.bits[1] = 0b00000000000000000000001111101000;
  src1.bits[2] = 0b00000000000000000000000000000000;
  src1.bits[3] = 0b00000000000000000000000000000000;
  s21_from_float_to_decimal(1.01, &src2);
  res = s21_mul(src1, src2, &result);
  origin_res = 0;
  ck_assert_int_eq(result.bits[0], 1010000);
  ck_assert_int_eq(result.bits[1], 101000);
...
START_TEST(s21_mul_35) {
  ...
  src2.bits[0] = 0b00000000000000011000011010100000;
  src2.bits[1] = 0b00000000000000000000000000000000;
  src2.bits[2] = 0b00000000000000000000000000000000;
  src2.bits[3] = 0b00000000000000100000000000000000;
  int res = s21_mul(src1, src2, &result);
  ck_assert_int_eq(result.bits[0], 1000000000);
...
Suite *test_multiplication() {
  Suite *s = suite_create("\033[1;30;47m S21_MUL \033[0;0;0m");
  TCase *o = tcase_create("\033[1;30;47m s21_mul \033[0;0;0m");
  suite_add_tcase(s, o);

  tcase_add_test(o, s21_mul_1);
  tcase_add_test(o, s21_mul_2);
  tcase_add_test(o, s21_mul_3);
  tcase_add_test(o, s21_mul_4);
  tcase_add_test(o, s21_mul_5);
  tcase_add_test(o, s21_mul_6);
  tcase_add_test(o, s21_mul_7);
  tcase_add_test(o, s21_mul_8);
  tcase_add_test(o, s21_mul_9);
  tcase_add_test(o, s21_mul_10);
  tcase_add_test(o, s21_mul_11);
  tcase_add_test(o, s21_mul_12);
  tcase_add_test(o, s21_mul_13);
  tcase_add_test(o, s21_mul_14);
  tcase_add_test(o, s21_mul_15);
  tcase_add_test(o, s21_mul_16);  // плохой тест
  tcase_add_test(o, s21_mul_17);
  tcase_add_test(o, s21_mul_18);
  tcase_add_test(o, s21_mul_19);
  tcase_add_test(o, s21_mul_20);
  tcase_add_test(o, s21_mul_21);
  tcase_add_test(o, s21_mul_22);
  tcase_add_test(o, s21_mul_23);
  tcase_add_test(o, s21_mul_24);
  tcase_add_test(o, s21_mul_25);
  tcase_add_test(o, s21_mul_26);
  tcase_add_test(o, s21_mul_27);
  tcase_add_test(o, s21_mul_28);
  tcase_add_test(o, s21_mul_29);
  tcase_add_test(o, s21_mul_30);
  tcase_add_test(o, s21_mul_31);
  tcase_add_test(o, s21_mul_32);
  tcase_add_test(o, s21_mul_33);
  tcase_add_test(o, s21_mul_34);
  tcase_add_test(o, s21_mul_35);
