...
START_TEST(s21_less_0) {
  ...
  int check = s21_is_less(value_1, value_2);
...
Suite *suite_less(void) {
  Suite *suite = suite_create("\033[1;30;47m S21_IS_LESS \033[0;0;0m");
  TCase *test_case = tcase_create("\033[1;30;47m s21_is_less \033[0;0;0m");
  suite_add_tcase(suite, test_case);

  tcase_add_test(test_case, s21_less_0);
  tcase_add_test(test_case, s21_less_1);
  tcase_add_test(test_case, s21_less_2);
  tcase_add_test(test_case, s21_less_3);
  tcase_add_test(test_case, s21_less_4);
  tcase_add_test(test_case, s21_less_5);
  tcase_add_test(test_case, s21_less_6);
  tcase_add_test(test_case, s21_less_7);
  tcase_add_test(test_case, s21_less_8);
  tcase_add_test(test_case, s21_less_9);
  tcase_add_test(test_case, s21_less_10);
  tcase_add_test(test_case, s21_less_11);
  tcase_add_test(test_case, s21_less_12);
  tcase_add_test(test_case, s21_less_13);
  tcase_add_test(test_case, s21_less_14);
  tcase_add_test(test_case, s21_less_15);
  tcase_add_test(test_case, s21_less_16);
